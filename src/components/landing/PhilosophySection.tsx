// FILE: src/components/landing/PhilosophySection.tsx — Nội quy (fetch động, fallback)
"use client";
...
export function PhilosophySection() {
  ...
  useEffect(() => { fetchBlock("philosophy").then((d) => { if (d?.items?.length) setItems(d.items); }); }, []);
  return (
      ...
      <ScrollReveal>
        <div className="pb-10 pt-[60px]">
          <div className="mb-2 flex items-center gap-3">
            ...
            <h3 className="font-display text-[2rem] font-bold text-royal">Phong Cách Dạy & Nội Quy Học Viên</h3>
          </div>
